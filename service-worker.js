...
if (!self.define) {
    ...
    self.define = (r, a) => {
        ...
        let f = {};
        const n = (e) => c(e, d),
            o = { module: { uri: d }, exports: f, require: n };
        i[d] = Promise.all(r.map((e) => o[e] || n(e))).then((e) => (a(...e), f));
    };
}
define(["./js/workbox-b05d7040"], function (e) {
    "use strict";
    self.addEventListener("message", (e) => {
        e.data && "SKIP_WAITING" === e.data.type && self.skipWaiting();
    }),
        e.precacheAndRoute(manifest,
            {}
        );
